...
def parse_args():
    ...
    parser.add_argument("--diamond_tsv", help="Path to CSV file with assigned segments and species")
...
def main():
    ...
    diamond_subset=diamond_tsv[["Accession", "assigned_species", "assigned_segment"]]
